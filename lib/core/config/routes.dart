...
import 'package:xpressatec/presentation/features/therapists/screens/therapist_detail_screen.dart';
...
class AppRoutes {
  static final routes = [
    ...
    GetPage(
      name: Routes.therapistDetail,
      page: () => const TherapistDetailScreen(),
    ),
    GetPage(
